...
import com.github.standobyte.jojo.network.packets.fromserver.*;
...
public class PacketManager {
    ...
    public static void init() {
        ...
        registerMessage(serverChannel, new TrHamonWallClimbingPacket.Handler(),            Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        ...
        registerMessage(serverChannel, new TrFreezeShieldPacket.Handler(),                 Optional.of(NetworkDirection.PLAY_TO_CLIENT));
    }
